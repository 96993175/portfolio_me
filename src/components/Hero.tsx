...
export default function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 3D model animation with hardware acceleration
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4" style={{ pointerEvents: 'none' }}>
        <div 
          ref={welcomeBoxRef}
          className="animated absolute left-0 top-0 bottom-0 w-1/2 flex flex-col items-center justify-center px-8 transition-all duration-500"
          style={{
        ...
        >
          ...
          {/* CTA Buttons */}
          <div ref={ctaRef} className="animated flex gap-4 mb-6" style={{ pointerEvents: 'auto' }}>
            <button 
      ...
      {/* Scroll indicator */}
      <div className="animated absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce z-30">
